...
#define SUBMIT_FIELD(p) \
  do { \
   ...
   if (cb1 && (p->options & CSV_EMPTY_IS_NULL) && !quoted && entry_pos == 0) \
     cb1(NULL, entry_pos, data, p->obj); \
   else if (cb1) \
     cb1(p->entry_buf, entry_pos, data, p->obj); \
...
int
csv_init(struct csv_parser *p, unsigned char options, void * obj)
{
...
int
csv_fini(struct csv_parser *p, void (*cb1)(void *, size_t, void *, void *), void (*cb2)(int c, void *, void *), void *data)
{
...
size_t
csv_parse(struct csv_parser *p, const void *s, size_t len, void (*cb1)(void *, size_t, void *, void *), void (*cb2)(int c, void *, void *), void *data)
{
