...
/* Function Prototypes */
int csv_init(struct csv_parser *p, unsigned char options, void * obj);
int csv_fini(struct csv_parser *p, void (*cb1)(void *, size_t, void *, void *), void (*cb2)(int, void *, void *), void *data);
void csv_free(struct csv_parser *p);
int csv_error(struct csv_parser *p);
char * csv_strerror(int error);
size_t csv_parse(struct csv_parser *p, const void *s, size_t len, void (*cb1)(void *, size_t, void *, void *), void (*cb2)(int, void *, void *), void *data);
